...
{
    internal class RT_WorldGenStep_Terrain : WorldGenStep
    {
        [Unsaved]
        ...
        {
            float freqMultiplier = RT_WorldGenStep_Terrain.FreqMultiplier;
            ...
            this.noiseElevation = new ScaleBias((double)RT_WorldGenStep_Terrain.ElevationRange.Span, (double)RT_WorldGenStep_Terrain.ElevationRange.min, this.noiseElevation);
        }
        ...
        private void SetupSwampinessNoise()
        {
            ...
            InverseLerp rhs = new InverseLerp(this.noiseElevation, RT_WorldGenStep_Terrain.SwampinessMaxElevation.max, RT_WorldGenStep_Terrain.SwampinessMaxElevation.min);
            this.noiseSwampiness = new Multiply(this.noiseSwampiness, rhs);
            InverseLerp rhs2 = new InverseLerp(this.noiseRainfall, RT_WorldGenStep_Terrain.SwampinessMinRainfall.min, RT_WorldGenStep_Terrain.SwampinessMinRainfall.max);
        ...
        private Tile GenerateTileFor(int tileID)
        {
            ...
            float num = RT_WorldGenStep_Terrain.BaseTemperatureAtLatitude(Find.WorldGrid.LongLatOf(tileID).y);
            num -= RT_WorldGenStep_Terrain.TemperatureReductionAtElevation(tile.elevation);
        ...
        private static float BaseTemperatureAtLatitude(float lat)
        {
            ...
            return RT_WorldGenStep_Terrain.AvgTempByLatitudeCurve.Evaluate(x);
        }
