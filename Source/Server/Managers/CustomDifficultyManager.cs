...
namespace GameServer
{
    public static class CustomDifficultyManager
    {
        ...
        {
            if (!client.isAdmin) ResponseShortcutManager.SendIllegalPacket(client, $"Player {client.username} attmpeted to set the custom difficulty while not being an admin");
            else
            {
